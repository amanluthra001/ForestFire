...
<div style='display:flex;align-items:center;justify-content:center;gap:40px;margin-top:10px;margin-bottom:20px;flex-wrap:wrap;'>
    ...
    <div style='max-width:550px;text-align:left;'>
        <h1 style='color:#b33a3a;font-size:38px;margin-bottom:5px;'>🔥 Kelowna Wildfire Risk Portal</h1>
...
st.markdown("<h2 class='section-title'>🗺 Live Fire Risk Map</h2>", unsafe_allow_html=True)
if ss.preds:
    ...
    for _, row in gdf.iterrows():
        ...
        🌧 Rain: {w.get('precipitation','N/A')} mm/h
        """
        folium.GeoJson(
